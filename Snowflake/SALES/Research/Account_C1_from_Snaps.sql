-- APTTUS_DW.SF_CONGA1_0."Account_C1" source

--CREATE OR REPLACE VIEW "Account_C1"  COMMENT = 'all purpose Conga1.0 account view' AS 
...
SELECT A.ACCOUNTID_18__C --, A.id   
       ...
       , A.New_Account_Owner__c
       , A.Original_Conga_1_0_Territory_Manager__c
...
FROM   APTTUS_DW.SNAPSHOTS.ACCOUNT_C1_HISTORY A 
