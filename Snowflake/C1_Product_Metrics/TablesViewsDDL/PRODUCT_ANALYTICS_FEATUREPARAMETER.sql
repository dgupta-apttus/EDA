...
CREATE TABLE PRODUCT_ANALYTICS_FEATUREPARAMETER 
  ( 
...
update APTTUS_DW.SF_CONGA1_1.PRODUCT_ANALYTICS_FEATUREPARAMETER
...
-- original create
create table APTTUS_DW.SF_CONGA1_1.PRODUCT_ANALYTICS_FEATUREPARAMETER
  AS
