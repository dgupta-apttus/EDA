...
AS 
        SELECT 'Conga1.0' AS CRM_SOURCE
             , MONTH
             , E.CUSTOMER_ORG
             , COALESCE(F.ACCOUNTID_18__C, 'Not Found') AS SALES_ACCOUNT_ID
             , COALESCE(F.ACCOUNT_NAME, 'Name Not Found') AS ACCOUNT_NAME
             , E.ACCOUNT_ID as LMA_ACCOUNT_ID
...
UNION ALL 
        SELECT 'Apttus1.0' AS CRM_SOURCE
             , MONTH
             , E.CUSTOMER_ORG
             , COALESCE(G.ACCOUNTID_18__C, 'Not Found') AS SALES_ACCOUNT_ID            
             , COALESCE(G.ACCOUNT_NAME, E.ACCOUNT_NAME, 'Name Not Found') as ACCOUNT_NAME 
             , E.OLDCRM_ACCOUNT_ID as LMA_ACCOUNT_ID
        ...
        LEFT OUTER JOIN             APTTUS_DW.SF_PRODUCTION."Account_C2" G
                          ON E.ACCOUNT_ID = G.ACCOUNTID_18__C                                                 
;
