DROP VIEW APTTUS_DW.PRODUCT."FMA_Feature_Daily_Values" ;

CREATE OR REPLACE VIEW APTTUS_DW.PRODUCT."FMA_Feature_Daily_Values"  
...
inner join            APTTUS_DW.PRODUCT.PRODUCT_ANALYTICS_FEATUREPARAMETER P
