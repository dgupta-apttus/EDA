...
select count(*) from APTTUS_DW.SNAPSHOTS.LMA_LICENSE_CLMCPQ_SNAP_1603974173494_1604059275315;
...
INSERT INTO APTTUS_DW.SNAPSHOTS.LMA_LICENSE_CLMCPQ_SNAP_1603974173494_1604059275315 
...
DROP TABLE APTTUS_DW.SNAPSHOTS.LMA_LICENSE_CLMCPQ_SNAP_1;
-- change first snap to be the recently replaced
alter table APTTUS_DW.SNAPSHOTS.LMA_LICENSE_CLMCPQ_SNAP_1603974173494_1604059275315 rename to APTTUS_DW.SNAPSHOTS.LMA_LICENSE_CLMCPQ_SNAP_1;
select count(*) from APTTUS_DW.SNAPSHOTS.LMA_LICENSE_CLMCPQ_SNAP_1;
...
-- change -- update to most recent snap	
	APTTUS_DW.SNAPSHOTS.LMA_LICENSE_CLMCPQ_SNAP_1604724178734_1604750472681
UNION
SELECT
	ACCOUNTID__C
	, ACCOUNT_NAME__C
