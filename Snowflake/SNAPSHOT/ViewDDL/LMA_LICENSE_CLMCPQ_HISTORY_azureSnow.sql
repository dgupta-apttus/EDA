...
select count(*) from APTTUS_DW.SNAPSHOTS.LMA_LICENSE_CLMCPQ_SNAP_1604724178734_1608717726565;

-- CHANGE -- uncommend insert and update table name to previous snap
-- CHANGE -- manage columns near bottom
INSERT INTO APTTUS_DW.SNAPSHOTS.LMA_LICENSE_CLMCPQ_SNAP_1604724178734_1605952931520 
      ...
      --
      , SFLMA__PACKAGE_VERSION_NUMBER__C, SFLMA__INSTANCE__C, SFLMA__VERSION_NUMBER__C, SFLMA__LAST_MODIFIED__C
      --
      , SNAP_LOAD_AT) 
...
DROP TABLE APTTUS_DW.SNAPSHOTS.LMA_LICENSE_CLMCPQ_PRIOR;
ALTER TABLE APTTUS_DW.SNAPSHOTS.LMA_LICENSE_CLMCPQ_SNAP_1 rename to APTTUS_DW.SNAPSHOTS.LMA_LICENSE_CLMCPQ_PRIOR;
-- change first snap to be the recently replaced
alter table APTTUS_DW.SNAPSHOTS.LMA_LICENSE_CLMCPQ_SNAP_1604724178734_1605952931520 rename to APTTUS_DW.SNAPSHOTS.LMA_LICENSE_CLMCPQ_SNAP_1;
select count(*) from APTTUS_DW.SNAPSHOTS.LMA_LICENSE_CLMCPQ_SNAP_1;
...
-- change -- update to most recent snap	
	APTTUS_DW.SNAPSHOTS.LMA_LICENSE_CLMCPQ_SNAP_1604724178734_1608717726565
UNION
SELECT
	ACCOUNTID__C
	, ACCOUNT_NAME__C
